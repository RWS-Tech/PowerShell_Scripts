...
$64BitPath = "$Env:ProgramFiles\Globalscape\EFT Server Enterprise\cftpsai.exe"

# 32-Bit File, add the rest of the file path
$32BitPath = "${Env:ProgramFiles(x86)}\Globalscape\EFT Server Enterprise\cftpsai.exe"
