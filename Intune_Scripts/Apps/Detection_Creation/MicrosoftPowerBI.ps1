...
$64BitPath = "$Env:ProgramFiles\Microsoft Power BI Desktop\bin\PBIDesktop.exe"

# 32-Bit File, add the rest of the file path
$32BitPath = "${Env:ProgramFiles(x86)}\Microsoft Power BI Desktop\bin\PBIDesktop.exe"
